    ...
    <AbsoluteFill style={{ background: `linear-gradient(180deg, ${colors.surface}, ${colors.bg})` }}>
      ...
      >
        ...
        >
          ...
          <div>
            <div style={{ fontFamily: fontDisplay, fontSize: 44, fontWeight: 700, letterSpacing: -1.5 }}>
              Identidade visual + cardápio
            </div>
            <div style={{ fontSize: 16, color: "#6B7280", marginTop: 6 }}>
              Preparada para Padaria Estrela • Válida até 22/06/2026
            </div>
          </div>
          ...
          <div style={{ background: "#fff", borderRadius: 14, padding: 28, border: "1px solid #E5E7EB", display: "flex", flexDirection: "column", gap: 12 }}>
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 6 }}>
              ...
              <span style={{ fontFamily: fontDisplay, fontSize: 38, fontWeight: 700, letterSpacing: -1 }}>R$ 6.400</span>
            </div>
          </div>
          ...
          <div style={{ display: "flex", justifyContent: "center", marginTop: 8 }}>
            <div
              style={{
                padding: "18px 46px",
                background: accepted ? colors.success : colors.primary,
                color: "#fff",
                borderRadius: 12,
                fontFamily: fontUI,
                fontWeight: 700,
                fontSize: 18,
                boxShadow: `0 16px 40px ${(accepted ? colors.success : colors.primary)}66`,
                display: "flex",
                alignItems: "center",
                gap: 12,
                transform: `scale(${accepted ? 1 + Math.min(checkS, 1) * 0.08 : 1})`,
              }}
            >
              {accepted ? "✓ Proposta aceita" : "Aceitar proposta"}
            </div>
          </div>
        </div>
      </div>

      {/* Confetti / pulse on accept */}
      {accepted && (
        <div
          style={{
            position: "absolute",
            top: "62%",
            left: "50%",
            transform: `translate(-50%, -50%) scale(${0.5 + checkS * 2.5})`,
            opacity: Math.max(0, 1 - checkS * 0.9),
            width: 200,
            height: 200,
            borderRadius: "50%",
      ...
      <Cursor
        ...
        click={[130]}
      />
      <Caption text={accepted ? "Aceita com um clique." : "Seu cliente recebe um link limpo e direto."} from={10} />
    </AbsoluteFill>
  );
};
