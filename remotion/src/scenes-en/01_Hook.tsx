...
const Doc: React.FC<{
  ...
  return (
    ...
    >
      ...
      >
        <line x1="20" y1="20" x2={20 + 320 * cross} y2={20 + 190 * cross} stroke="#EF4444" strokeWidth="6" strokeLinecap="round" />
        <line x1="340" y1="20" x2={340 - 320 * cross} y2={20 + 190 * cross} stroke="#EF4444" strokeWidth="6" strokeLinecap="round" />
      </svg>
    </div>
  );
};
...
export const Hook: React.FC = () => {
  return (
    <AbsoluteFill style={{ background: `radial-gradient(circle at 50% 40%, ${colors.surface}, ${colors.bg})` }}>
      <Doc
        title="WhatsApp — Client A"
        body="Hi! Here's the quote: 1) Strategy $2,500 2) Posts $1,800 3) Setup $900..."
        bg="#DCF8C6"
        rotate={-8}
        delay={0}
        from={{ x: 280, y: 700 }}
      ...
      />
      <Doc
        title="sales_2026.xlsx"
        body={"Client | Status | Value\nA | sent | 4,300\nB | ??? | ???\nC | forgot to send"}
        bg="#F0FDF4"
        rotate={-3}
        delay={20}
        from={{ x: 1280, y: 720 }}
      ...
      >
        Are your proposals <span style={{ color: "#EF4444" }}>scattered</span>?
      </div>
      <Caption text="WhatsApp, Word, spreadsheets — proposals get lost." from={120} />
    </AbsoluteFill>
  );
};
